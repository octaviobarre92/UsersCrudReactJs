   ...
   <oracle-xsl-mapper:schema>
      ...
      <oracle-xsl-mapper:mapTargets>
         <oracle-xsl-mapper:target type="WSDL">
            ...
            <oracle-xsl-mapper:rootElement name="consultarDocumentoResponse" namespace="http://sura.com.pa/integrationECM/"/>
         </oracle-xsl-mapper:target>
      </oracle-xsl-mapper:mapTargets>
      <!--GENERATED BY ORACLE XSL MAPPER 12.2.1.4.0(XSLT Build 190828.0353.3300) AT [THU JUL 16 10:56:48 COT 2020].-->
   </oracle-xsl-mapper:schema>
   <!--User Editing allowed BELOW this line - DO NOT DELETE THIS LINE-->
   <xsl:template match="/">
      <tns:consultarDocumentoResponse>
         ...
         <xsl:choose>
            <xsl:when test="/ns0:ObtenerDocumentoOnBaseMsjResp/ns0:CabeceraResp/dcomcom:EstadoGeneral/dcomcom:Status = &quot;OK&quot;">
               <msgDesc>
                  <xsl:value-of select="/ns0:ObtenerDocumentoOnBaseMsjResp/ns0:CabeceraResp/dcomcom:EstadoGeneral/dcomcom:Descripcion"/>
               </msgDesc>
            </xsl:when>
            <xsl:when test="/ns0:ObtenerDocumentoOnBaseMsjResp/ns0:CabeceraResp/dcomcom:EstadoGeneral/dcomcom:Status = &quot;ERR&quot;">
               <msgDesc>
                  <xsl:value-of select="concat (/ns0:ObtenerDocumentoOnBaseMsjResp/ns0:CabeceraResp/dcomcom:EstadosPorRegistro/dcomcom:Estado/dcomcom:Descripcion, /ns0:ObtenerDocumentoOnBaseMsjResp/ns0:CabeceraResp/dcomcom:EstadoGeneral/dcomcom:Descripcion )"/>
               </msgDesc>
            </xsl:when>
         </xsl:choose>
      </tns:consultarDocumentoResponse>
