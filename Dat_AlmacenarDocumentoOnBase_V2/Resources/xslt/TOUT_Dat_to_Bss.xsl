   ...
   <oracle-xsl-mapper:schema>
      ...
      <oracle-xsl-mapper:mapSources>
         <oracle-xsl-mapper:source type="WSDL">
            ...
            <oracle-xsl-mapper:rootElement name="OBDocStoreResponse" namespace="http://tempuri.org/"/>
      ...
      <!--GENERATED BY ORACLE XSL MAPPER 12.2.1.4.0(XSLT Build 190828.0353.3300) AT [SAT MAY 02 14:35:40 COT 2020].-->
   </oracle-xsl-mapper:schema>
   <!--User Editing allowed BELOW this line - DO NOT DELETE THIS LINE-->
   <xsl:template match="/">
      <tns:AlmacenarDocumentoOnBaseMsjResp>
         <tns:CabeceraResp>
            <dcomcom:EstadoGeneral>
               <dcomcom:Status>
                  <xsl:value-of select="/ns0:OBDocStoreResponse/ns0:OBDocStoreResult/ns1:status"/>
               </dcomcom:Status>
               <dcomcom:Descripcion>
                  <xsl:value-of select="/ns0:OBDocStoreResponse/ns0:OBDocStoreResult/ns1:sDesc"/>
               </dcomcom:Descripcion>
            </dcomcom:EstadoGeneral>
         </tns:CabeceraResp>
         <tns:Documento>
            <dutigdoc:IdDocumentoECM>
               <xsl:value-of select="/ns0:OBDocStoreResponse/ns0:OBDocStoreResult/ns1:docHandle"/>
            </dutigdoc:IdDocumentoECM>
         </tns:Documento>
      </tns:AlmacenarDocumentoOnBaseMsjResp>
   </xsl:template>
