...
declare namespace ns1="http://www.sura.com/ConvertirCotizacionPoliza";
(:: import schema at "../NXSD/Convertir_Cotizacion_Poliza_RQ.xsd" ::)

declare variable $rqPoliza as element() (:: schema-element(ns1:OBJETO_CONVERTIR_POLIZA) ::) external;

declare function local:func($rqPoliza as element() (:: schema-element(ns1:OBJETO_CONVERTIR_POLIZA) ::)) as element() (:: schema-element(ns2:ConvertQuotationToApplicationRq) ::) {
    <ConvertQuotationToApplicationRq>
