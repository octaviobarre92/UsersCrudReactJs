   ...
   <oracle-xsl-mapper:schema>
      ...
      <oracle-xsl-mapper:mapTargets>
         <oracle-xsl-mapper:target type="WSDL">
            ...
            <oracle-xsl-mapper:rootElement name="AnularRefPagoRq" namespace="http://www.ctinsuretech.com/SURA/PA/INSIS/BLC/custom/AdmonEgresosService/definitions"/>
         </oracle-xsl-mapper:target>
      </oracle-xsl-mapper:mapTargets>
      <!--GENERATED BY ORACLE XSL MAPPER 12.2.1.4.0(XSLT Build 190828.0353.3300) AT [SAT APR 04 19:33:57 COT 2020].-->
   </oracle-xsl-mapper:schema>
   <!--User Editing allowed BELOW this line - DO NOT DELETE THIS LINE-->
   <xsl:template match="/">
      <tns:AnularRefPagoRq>
         <tns:numRefPago>
            <xsl:value-of select="/ns0:AnularReferenciaPagoMsjSol/ns0:IdReferenciaPago"/>
         </tns:numRefPago>
      </tns:AnularRefPagoRq>
   </xsl:template>
</xsl:stylesheet>
